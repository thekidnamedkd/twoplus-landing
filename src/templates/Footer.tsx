...
const Footer = () => (
  <Background img="" color="bg-tpBlack-base">
    <Section>
      <CenteredFooter
        logo={<Logo />}
        iconList={
          <>
            ...
            <Link href="https://twitter.com/twoplus_xyz">
              <a target="_blank">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://twoplus.mirror.xyz/">
              <a target="_blank">
                <svg
                  width="144"
                  height="185"

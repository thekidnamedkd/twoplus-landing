  ...
  <section className="relative">
    <Background color="bg-tpBlack-base" img="bg-top-img">
      ...
      <section className="flex justify-center">
        <button className="mb-[7%] mx-auto px-5 py-3 text-3xl lg:px-20 lg:py-5 font-bold sm:text-4xl lg:text-4xl transition-colors duration-300 border rounded-lg shadow-[0px_0px_10px_3px] bg-tpBlack-base text-tpCream-base border-tpBerry-base shadow-tpBerry-base  hover:bg-tpBerry-base hover:text-tpBlack-base">
          <Link href="/">
            <a>More on Mirror</a>
          </Link>
        </button>
